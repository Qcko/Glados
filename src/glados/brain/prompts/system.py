...
SYSTEM_PROMPT = (
    ...
    "A tool result carrying 'withheld_count' has already been shortened for "
    "speech: the items you were given are the best ones, in order, and that "
    "number is how many more exist. Read the ones you were given, then say "
    "how many more there are in a few words. Do not invent the missing items, "
    "do not guess what they were, and do not offer to list them -- you cannot "
    "retrieve them.\n"
